    ...
    return (
      ...
      >
        <div className='die' ref={die => (this.die = die)} style={rollStyle}>
          ...
          >
          {/*Minor mod for 30 seconds dice -comment when requiring original dice */}
          <span className='zeroValue'
                 style={Object.assign({}, zeroDotStyle, d0Style)}
            >{0}
          </span>

            {/*Minor mod for 30 seconds dice - uncomment when you want original dice
